...
if TYPE_CHECKING:
    ...
    VLLM_ROCTX_SCOPES_FOR_PROFILING: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Add optional roctx scopes for profiling on ROCm, disable to avoid overheads
    "VLLM_ROCTX_SCOPES_FOR_PROFILING": lambda: bool(
        int(os.getenv("VLLM_ROCTX_SCOPES_FOR_PROFILING", "0"))
    ),
